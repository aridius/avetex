...
class ControllerExtensionModuleCustomShipping extends Controller {
	public function index($setting) {
		...
		if (isset($setting['status']) && (bool)$setting['status'] === true && $this->cart->hasShipping()) {
			...
			$data['custom_showcountry'] = $this->config->get('module_custom_showcountry');
			...
			if (isset($this->session->data['shipping_address']['country_id'])) {
				...
				$data['country_id'] = $this->config->get('module_custom_country_id');
			}

			if (isset($this->session->data['shipping_address']['zone_id'])) {
				$data['zone_id'] = $this->session->data['shipping_address']['zone_id'];
			} else {
				$data['zone_id'] = $this->config->get('module_custom_zone_id');
			}
